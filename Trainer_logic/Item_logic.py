class Item_Effects(self):
    ...
    def Boost_effects(self):
        
    def Orb_effects(self):
        
    def Emblem_effects(self):
        
    def Earring_effects(self):
        
    def Ring_effects(self):
        
    def Fruit_effects(self):
        
    def Mark_efrects(self):
